...
class ProjectEstimatorAPITester:
    def __init__(self, base_url="https://cost-analyzer-29.preview.emergentagent.com"):
...
def main():
    ...
    print(f"Testing against: https://cost-analyzer-29.preview.emergentagent.com/api")
