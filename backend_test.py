...
class ProjectEstimatorAPITester:
    def __init__(self, base_url="https://resource-planner-45.preview.emergentagent.com"):
...
def main():
    ...
    print(f"Testing against: https://resource-planner-45.preview.emergentagent.com/api")
