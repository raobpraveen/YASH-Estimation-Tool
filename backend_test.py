...
class ProjectEstimatorAPITester:
    def __init__(self, base_url="https://project-quoter-4.preview.emergentagent.com"):
...
def main():
    ...
    print(f"Testing against: https://project-quoter-4.preview.emergentagent.com/api")
