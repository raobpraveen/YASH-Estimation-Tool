...
class ProjectEstimatorAPITester:
    def __init__(self, base_url="https://yash-estpro-preview.preview.emergentagent.com"):
...
def main():
    ...
    print(f"Testing against: https://yash-estpro-preview.preview.emergentagent.com/api")
