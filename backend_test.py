...
class ProjectEstimatorAPITester:
    def __init__(self, base_url="https://project-estimator-26.preview.emergentagent.com"):
...
def main():
    ...
    print(f"Testing against: https://project-estimator-26.preview.emergentagent.com/api")
